...
type InvoiceServiceClient interface {
	CreateInvoice(ctx context.Context, in *InvoiceFilter, opts ...grpc.CallOption) (*InvoiceData, error)
}
...
func (c *invoiceServiceClient) CreateInvoice(ctx context.Context, in *InvoiceFilter, opts ...grpc.CallOption) (*InvoiceData, error) {
...
type InvoiceServiceServer interface {
	CreateInvoice(context.Context, *InvoiceFilter) (*InvoiceData, error)
...
func (UnimplementedInvoiceServiceServer) CreateInvoice(context.Context, *InvoiceFilter) (*InvoiceData, error) {
...
func _InvoiceService_CreateInvoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InvoiceServiceServer).CreateInvoice(ctx, req.(*InvoiceFilter))
	}
...
var InvoiceService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "grpc/proto_invoice/invoice.proto",
}
